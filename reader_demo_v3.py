...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        bookurl = QUrl.fromLocalFile(mydir + '/reader/index.html')
        bookurl.setQuery('bookPath=books/ebook/')
    ...
    def readsettings(self):
        settings = QSettings('Sigil','EpubJSReader')
...
app.setApplicationName("EpubJSReader")
